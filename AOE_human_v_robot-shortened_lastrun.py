...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\anhtn\\OneDrive - PennO365\\Documents\\GitHub\\AO_human_v_robot_main\\AOE_human_v_robot-shortened_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    loopLoader = data.TrialHandler(nReps=1.0, method='sequential', 
        ...
        trialList=data.importConditions('AOE_final_randomized_trials.xlsx'),
    ...
    for thisLoopBlock in loopBlock:
        ...
        for thisLoopTrial in loopTrial:
            ...
            # keep track of which components have finished
            executionPhaseComponents = [executionCircle]
